...
const WhatsAppWidget = () => {
  return (
    <motion.a
      ...
      className="fixed bottom-[7.25rem] right-6 w-10 h-10 rounded-full bg-[#25D366] text-white shadow-md shadow-[#25D366]/30 flex items-center justify-center z-40 hover:scale-110 active:scale-95 transition-transform duration-300 group"
